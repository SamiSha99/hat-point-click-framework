// Original script was made by Jasmine! Check her out:
// Twitter: https://twitter.com/Lady_Jazzrabbit
// Steam: https://steamcommunity.com/id/LadyJazzrabbit
// Note: Name of the Class was modified with my signature to avoid possible mod confliction (Jaw_ -> SS_)
Class SS_CamMode_FirstPerson extends Hat_CamMode_Script;
...
function Render(Hat_PlayerCamera_Base PlayerCamera, Pawn TPawn, const float DeltaTime, out Vector camEnd, out Rotator camRotation, const Rotator PlayerRotation, out float FoV, out sDynamicCameraInfo DynamicCameraInfo)
{
	...
	if(isFocus && ply != None) 
	{
        ...
        if(ply.CarriedObject != None)
        {
            ...
            /*
            * SamiSha Edit: Added != None check to avoid warnings spam
            */
            if(Carried != None)
